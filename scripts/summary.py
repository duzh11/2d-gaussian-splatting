...
if __name__ == "__main__":
    ...
    for json_name in ['result_mesh_tsdf', 'result_mesh_poisson', 'results_train', 'results_test', \
                      'results_train_depth', 'results_test_depth', 'results_train_normal', 'results_test_normal']:
